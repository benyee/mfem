...
public:
   ...
   /** Constructor with scalar coefficients.
       Result is _alpha * Ain + _beta * Bin */
   VectorSumCoefficient(VectorCoefficient &Ain, VectorCoefficient &Bin,
